% "{'classe':('PSI'),'chapitre':'dyn_inertie','type':('application'),'titre':'Barrière sur la Tamise', 'source':'Florestan Mathurin','comp':['B2-10',],'corrige':False}"
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_04_01_Activation_01_Barriere_qr}
\end{marginfigure}
\fi
