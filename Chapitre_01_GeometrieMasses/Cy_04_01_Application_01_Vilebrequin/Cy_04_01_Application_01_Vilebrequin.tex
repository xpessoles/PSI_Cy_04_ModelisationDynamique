% "{'classe':('PSI'),'chapitre':'dyn_inertie','type':('application'),'titre':'Vilebrequin de moteur', 'source':'C. Gamelon et P. Dubois','comp':['B2-10',],'corrige':True}"
\setchapterimage{bandeau}
\chapter*{Application \arabic{cptApplication} \\ 
Vilebrequin de moteur -- \ifprof Corrigé \else Sujet \fi}
\addcontentsline{toc}{section}{Application \arabic{cptApplication} : Vilebrequin de moteur -- \ifprof Corrigé \else Sujet \fi}
...
\marginnote{On note :
\begin{itemize}
\item $\rho=\SI{7200}{kg.m^{-3}}$ la masse volumique du matériau;
\item $a = \SI{20}{mm}$;
\item $b = \SI{30}{mm}$;
\item $e = \SI{5}{mm}$;
\item $l = \SI{20}{mm}$;
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_04_01_Application_01_Vilebrequin_qr}
\end{marginfigure}
\fi
