...
\def\xxfigures{
%\includegraphics[width=.7\linewidth]{triaxe}
...
\begin{center}
\includegraphics[width=\linewidth]{triaxe.png}
\end{center}
On note :
\begin{itemize}
...
\begin{center}
\includegraphics[width=.8\linewidth]{param.png}
\end{center}
...
\question{Déterminer analytiquement la position du centre de gravité $G_i$ du solide $A_1$ dans le repère $\rep{i}$.}
\ifprof
\begin{corrige}
