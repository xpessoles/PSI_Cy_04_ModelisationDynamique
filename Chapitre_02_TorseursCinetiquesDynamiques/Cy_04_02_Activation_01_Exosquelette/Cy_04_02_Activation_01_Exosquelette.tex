% "{'classe':('PSI'),'chapitre':'dyn_cin','type':('application'),'titre':'Assistance pour le maniement de charges dans l’industrie', 'source':'Concours Centrale Supelec TSI 2017','comp':('C1-05','C1-09'),'corrige':True}"
