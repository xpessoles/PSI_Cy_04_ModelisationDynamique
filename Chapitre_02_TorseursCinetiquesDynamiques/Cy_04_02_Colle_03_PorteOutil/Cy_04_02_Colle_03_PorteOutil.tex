...
\def\xxtitreexo{Colle 3 -- Régulateur}%Motorisation du moteur Haibike}
...
\subparagraph{}
\textit{Déterminer les torseurs cinétiques suivants : $\torseurci{1}{0}_O$, $\torseurci{2}{0}_O$.}


\subparagraph{}
\textit{Déterminer les torseurs dynamiques suivants : $\torseurdyn{1}{0}_O$, $\torseurdyn{2}{0}_O$. En déduire $\torseurdyn{1\cup 2}{0}_O$}
