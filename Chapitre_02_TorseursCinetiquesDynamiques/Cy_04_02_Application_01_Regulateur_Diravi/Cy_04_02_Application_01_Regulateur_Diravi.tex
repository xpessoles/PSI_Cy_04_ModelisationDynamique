...
\def\xxtitreexo{Application -- Régulateur centrifuge}
...
Afin de ne pas trop alourdir les calculs, on suppose constantes les vitesse de rotation $\dot{\theta}_1$ et $\dot{\theta}_2$.

\question{Discuter de la pertinence de ces hypothèses. Vous pourrez éventuellement les remettre en cause. }

\question{Déterminer :}\textit{
\begin{itemize}
\item le torseur dynamique $\torseurdyn{S_1}{R_0}$ en $O_1$;
\item le torseur dynamique  $\torseurdyn{S_2}{R_0}$ en $O_2$.
%\item le torseur dynamique  $\torseurdyn{E}{R_0}$ en $O_2$;
%\item et enfin l’énergie cinétique de (E) par rapport à (R0).
\end{itemize}}
...
\begin{center}
\includegraphics[width=.48\linewidth]{Cm_SansFrottement.png}
\includegraphics[width=.48\linewidth]{Cm_Frottement.png}
\end{center}
