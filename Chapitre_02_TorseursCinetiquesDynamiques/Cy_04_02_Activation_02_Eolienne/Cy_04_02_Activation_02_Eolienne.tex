% "{'classe':('PSI'),'chapitre':'dyn_cin','type':('td'),'titre':'Éolienne bipale', 'source':'Émilien Durif','comp':('C1-05','C2-09,'DYN-04'),'corrige':True}"
%\setchapterimage{bandeau}
\chapter*{Application \arabic{cptApplication} \\ 
Éolienne bipale -- \ifprof Corrigé \else Sujet \fi}
\addcontentsline{toc}{section}{Application \arabic{cptApplication} : Éolienne bipale -- \ifprof Corrigé \else Sujet \fi}
...
\marginnote{D'après Émilien Durif.}
%\marginnote[1cm]{
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_04_02_Activation_02_Eolienne_qr}
\end{marginfigure}
\fi
