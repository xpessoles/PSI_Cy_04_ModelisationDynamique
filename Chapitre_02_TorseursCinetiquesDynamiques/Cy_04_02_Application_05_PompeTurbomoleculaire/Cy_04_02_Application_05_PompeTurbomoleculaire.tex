% "{'classe':('PSI'),'chapitre':'dyn_cin','type':('application'),'titre':'Pompe turbo-moléculaire', 'source':'Centrale Supelec PSI 2009','comp':('C1-05','C2-09'),'corrige':False}"
%\setchapterimage{bandeau}
\chapter*{Application \arabic{cptApplication} \\ 
Pompe turbo-moléculaire -- \ifprof Corrigé \else Sujet \fi}
\addcontentsline{toc}{section}{Application \arabic{cptApplication} : Pompe turbo-moléculaire -- \ifprof Corrigé \else Sujet \fi}
...
\marginnote{Centrale Supelec PSI 2009.}
\marginnote[1cm]{
