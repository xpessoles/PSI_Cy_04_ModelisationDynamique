% "{'classe':('PSI'),'chapitre':'dyn_cin','type':('td'),'titre':'Stabilisateur passif d\\'image', 'source':'Mines Ponts 2018 - PSI','comp':('C1-05','C2-09','DYN-04'),'corrige':True}"
%\setchapterimage{bandeau}
\chapter*{TD \arabic{cptTD} \\ 
Stabilisateur passif d'image -- \ifprof Corrigé \else Sujet \fi}
\addcontentsline{toc}{section}{TD \arabic{cptTD} : Stabilisateur passif d'image $\star\star$-- \ifprof Corrigé \else Sujet \fi}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_04_02_TD_02_Stabilisateur_PFD_qr}
\end{marginfigure}
\fi
