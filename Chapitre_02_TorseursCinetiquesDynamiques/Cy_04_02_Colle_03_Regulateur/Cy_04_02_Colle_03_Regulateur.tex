% "{'classe':('PSI'),'chapitre':'dyn_cin','type':('colle'),'titre':'Régulateur', 'source':'','comp':('C1-05','C2-09'),'corrige':False}"
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_04_02_Colle_03_Regulateur_qr}
\end{marginfigure}
\fi
