...
&&& \\ \hline
\multicolumn{4}{p{8cm}}{} \\
\multicolumn{4}{p{8cm}}{$\vectrd{1+2}{0} = \vectrd{1}{0} + \vectrd{2}{0} = m_1\vectg{G_1}{1}{0}+m_2\vectg{G_2}{2}{0}$} \\
\multicolumn{4}{p{8cm}}{$\vectmd{A}{1+2}{0} = \vectmd{A}{1}{0} + \vectmd{A}{2}{0}$} \\
%
\end{tabular}  }
\end{center}
