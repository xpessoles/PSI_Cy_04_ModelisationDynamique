% "{'classe':('PSI'),'chapitre':'dyn_pfd','type':'cours','titre':'Résolution d\\'un problème de dynamique','source':' ','comp':('C1-05','C2-08'),'corrige':True}"
%  }"
...
\marginnote{\xpComp{DYN}{05}\xpComp{DYN}{06}}
