%%%% Paramétrage du TD %%%%
\def\xxactivite{\ifcolle Colle \else Application 4 \fi  \ifprof -- Corrigé \else \fi} % \normalsize \vspace{-.4cm}
...
\def\xxtitreexo{Chargement et déchargement des cargos porte-conteneurs  \ifnormal $\star$ \else \fi \ifdifficile $\star\star$ \else \fi \iftdifficile $\star\star\star$ \else \fi }
