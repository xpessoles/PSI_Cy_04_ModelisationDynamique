...
\begin{itemize}
\item $\gamma_1 =\angl{y_0}{y_1}=\angl{z_0}{z_1}$ -- mouvement de roulis du bateau par rapport au repère galiléen ;
\item $\gamma_2=\angl{z_1}{z_2}=\angl{x_1}{x_2}$ -- rotation du cadre 2 par rapport au bateau 1 ;
\item $\gamma_3 =\angl{x_2}{x_3}=\angl{y_2}{y_3}$ -- rotation du volant d’inertie 3 par rapport au cadre 2. 
\end{itemize}
}
...
$\torseurstat{T}{2_m}{3} = \torseurl{\vectf{2_m}{3}=\vect{0}}{\vectm{P}{2_m}{3}=M_m(t)\vz{3}}{\forall P}.$

L'action du vérin entre 1 et 2 est modélisée par un moteur :

$\torseurstat{T}{1_m}{2} = \torseurl{\vectf{1_m}{2}=\vect{0}}{\vectm{O}{1_m}{2}=M(t)\vy{1}}{\forall P}.$

\question{Tracer le graphe de liaisons. Faire apparaître l'ensemble des actions mécaniques.}


\question{Proposer une stratégie permettant d'obtenir les lois de mouvements.}

%
\question{Mettre en \oe{}uvre cette stratégie.}
