% "{'classe':('PSI'),'chapitre':'dyn_pfd_vehicule','type':('application'),'titre':'Véhicule à trois roues Clever', 'source':'Concours Banque PT - SIA 2013','comp':('C1-05','C2-09'),'corrige':False}"
...
\marginnote{Concours Banque PT -- SIA 2013.}
\marginnote[1cm]{
...
\begin{figure}[!h]
\includegraphics[width=.8\linewidth]{tab_01}
...
%\centering
\includegraphics[width=\linewidth]{fig_1_1}
...
\begin{marginfigure}%[H]
\centering
\includegraphics[width=\linewidth]{fig_1_3}

\caption{Représentation graphique de la condition de non renversement}
\label{fig_1_3}
\end{marginfigure}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_04_03_PFD_Veh_App_02_Clever_qr}
\end{marginfigure}
\fi
