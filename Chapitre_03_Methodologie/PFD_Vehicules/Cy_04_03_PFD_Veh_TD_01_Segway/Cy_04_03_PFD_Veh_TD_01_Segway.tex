%%%% Paramétrage du TD %%%%
\def\xxactivite{\ifcolle Colle \else TD 3 \fi  \ifprof -- Corrigé \else \fi} % \normalsize \vspace{-.4cm}
...
\question{Exprimer la vitesse, notée  $\vect{V\left(G_E /\rep{0}\right)}$, du point $G_E$ dans son mouvement par rapport à $\rep{0}$ en fonction de $\dot{\theta}$ et $R_C$. Exprimer la vitesse linéaire $V_L$ du véhicule en fonction de $R_C$ et $\dot{\theta}$.}
